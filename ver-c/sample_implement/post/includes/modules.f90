...
! *** post parameter ***					     
  ...
  integer :: p_start,p_end,p_inc   				     
  integer, save :: nx, ny, gid					     
                                                                     
  double precision, save :: gpx, gpy, gpz			     
  double precision, save :: xmin, xmax				     
  double precision, save :: ymin, ymax				     
  double precision, save :: x_min, x_max			     
  double precision, save :: y_min, y_max			     
  double precision, save :: eta        (5001,n_panel)		     
  double precision, save :: d_height        (n_panel)		     
  double precision, save :: point    (2,5001,n_panel)		     
  double precision, save :: velo     (2,5001,n_panel)		     
  double precision, save :: pres       (5001,n_panel)		     
  double precision, save :: cp         (5001,n_panel)		     
  double precision, save :: sum             (n_panel)		     
